...
'''Get an object of type: setting and save the object to a report file'''
...
if __name__ == "__main__":
    ...
    parser = pytan.binsupport.setup_get_object_argparser(obj='setting', doc=__doc__)
    ...
    response = pytan.binsupport.process_get_object_args(
        parser=parser, handler=handler, obj='setting', args=args,
    )
